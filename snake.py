...
#     def __init__(self, canvas, snake, snake_x, snake_y, len_snake, apple, speed, direction, score, function_direction):
...
# def move_snake(event, x, y, snake, snake_x, snake_y, len_snake, apple, speed, direction, score, function_direction):
#     # global snake
#     # global snake_x
#     # global snake_y
#     # global len_snake
...
# # I need to use self
# canvas.bind_all("<KeyPress-Up>", lambda event: move_snake(event, 0, -1, snake, snake_x, snake_y, len_snake, apple, speed, direction, score, 'Up'))
# canvas.bind_all("<KeyPress-Down>", lambda event: move_snake(event, 0, 1, snake, snake_x, snake_y, len_snake, apple, speed, direction, score, 'Down'))
# canvas.bind_all("<KeyPress-Left>", lambda event: move_snake(event, -1, 0, snake, snake_x, snake_y, len_snake, apple, speed, direction, score, 'Left'))
# canvas.bind_all("<KeyPress-Right>", lambda event: move_snake(event, 1, 0, snake, snake_x, snake_y, len_snake, apple, speed, direction, score, 'Right'))
